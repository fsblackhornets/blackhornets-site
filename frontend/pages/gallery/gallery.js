...
const GALLERY_HOOKS = ["/frontend/pages/gallery/hooks/fetch.js"];

const loadGalleryScripts = (srcs) =>
	Promise.all(
		srcs.map(
			(src) =>
				new Promise((resolve) => {
...
document.addEventListener("DOMContentLoaded", () => {
	...
	Promise.all([
		loadGalleryScripts(GALLERY_HELPERS),
		loadGalleryScripts(GALLERY_HOOKS),
	]).then(() => {
