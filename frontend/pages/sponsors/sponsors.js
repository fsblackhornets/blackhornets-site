...
const SPONSOR_HOOKS = ["/frontend/pages/sponsors/hooks/fetch.js"];

const loadSponsorScripts = (srcs) =>
	Promise.all(
		srcs.map(
			(src) =>
				new Promise((resolve) => {
...
document.addEventListener("DOMContentLoaded", () => {
	Promise.all([
		loadSponsorScripts(SPONSOR_HELPERS),
		loadSponsorScripts(SPONSOR_HOOKS),
	]).then(() => {
