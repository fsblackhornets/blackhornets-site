...
const CONTACT_HOOKS = [
    '/frontend/pages/contact/hooks/submit.js',
];

const loadContactScripts = (srcs) => Promise.all(
...
document.addEventListener('DOMContentLoaded', () => {
    Promise.all([loadContactScripts(CONTACT_HELPERS), loadContactScripts(CONTACT_HOOKS)]).then(() => {
