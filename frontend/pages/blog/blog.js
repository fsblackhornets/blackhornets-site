...
const BLOG_HOOKS = ["/frontend/pages/blog/hooks/fetch.js"];

const loadBlogScripts = (srcs) =>
	Promise.all(
		srcs.map(
			(src) =>
				new Promise((resolve) => {
...
document.addEventListener("DOMContentLoaded", () => {
	Promise.all([
		loadBlogScripts(BLOG_HELPERS),
		loadBlogScripts(BLOG_HOOKS),
	]).then(() => {
