...
const FOOTER_HELPERS = [
    '/frontend/components/footer/helpers/render.js',
];
...
const loadScripts = (srcs) => Promise.all(
        ...
        const initComponents = () => {
            ...
            setTimeout(() => {
                document.querySelectorAll('.lang-btn').forEach(btn => {
                    btn.classList.toggle('active', btn.getAttribute('data-lang') === window.getCurrentLanguage?.());
                });
            }, 50);
